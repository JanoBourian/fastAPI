...
complaints = sqlalchemy.Table(
    ...
    sqlalchemy.Column("photo_uuid", sqlalchemy.ForeignKey("photos.uuid"), nullable=False),
    sqlalchemy.Column("status", sqlalchemy.Enum(enums_for_models.State), nullable=False, server_default=enums_for_models.State.pending.name),
    sqlalchemy.Column(
        "created_at",
        sqlalchemy.DateTime,
        nullable=False,
